...
<td>
<textarea required col="50" row="10" name="updateTime" id="updateTime"></textarea>
</td>
...
<td>
<textarea required col="50" row="10" name="remark" id="remark"></textarea>
</td>
...
<input type="hidden" name="page" value= "addNewInternshipRegd">
