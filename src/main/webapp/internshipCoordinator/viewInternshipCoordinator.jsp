...
<td>
<%=internshipCoordinator.getValue()%>
</td>
...
<td>
<%=internshipCoordinator.getShortName()%>
</td>
...
<input type="hidden" name="page" value= "viewInternshipCoordinator">
